...
function SignUp() {
  ...
  return (
    <>
      <section className="bg-gray-50 mx-12  md:mx-20 lg:mx-36 xl:mx-48 2xl:mx-64 dark:bg-gray-900 text-center py-8 w-full">
        <div className="container mx-auto">
          ...
          <div className="w-full max-w-lg mx-auto bg-white rounded-lg shadow-md dark:border dark:border-gray-700">
            <div className="p-6 space-y-4">
              ...
              <form className="space-y-4" action="#">
                ...
                <button
                  type="submit"
                  className="bg-gray-900 text-white rounded-lg px-4 py-2 mx-auto block w-full max-w-xs sm:max-w-sm md:max-w-md lg:max-w-lg hover:bg-gray-800 transition duration-300"
                >
                  ساخت اکانت
                </button>
