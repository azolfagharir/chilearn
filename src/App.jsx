    ...
    <>
      <div className="grid container ">
        ...
        <div className="flex flex-col justify-center items-center min-h-screen ">
          ...
          <div className="absolute inset-0 flex top-20 items-center justify-center">
            <h1 className="text-center text-4xl" dir="rtl">
              صحبت کردن آسان شد!
            </h1>
          </div>
          <br />
          ...
          <br />
          <br />
          <div className="absolute inset-0 flex top-52 items-center justify-center">
            <p className="text-center">
              اولین پلتفرم آموزش فارسی به کودکان زیر 5 سال
            </p>
          </div>
          <br />
          <br />
